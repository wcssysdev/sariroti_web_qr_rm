...
namespace App\Http\Controllers\MasterData\Sloc;
...
class ViewController extends Controller
{
    ...
    {
        $data = get_master_data("MA_SLOC");
        return view('master_data/sloc/view', [
            "data" => $data
        ]);
    }
    ...
    {
        $response = export_request_master_data_csv("sloc","SLOC");
    ...
    {
        $response = sync_master_data("SLOC");
        if ($response["code"] == 200) {
            return response()->json([
                "code" => 200,
