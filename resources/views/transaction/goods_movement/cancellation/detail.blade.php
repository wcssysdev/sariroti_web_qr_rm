...
<div class="card card-custom overflow-hidden">
    ...
    <form action="{{ route('transaction_goods_movement_cancellation_save') }}" method="POST" data-form-success-redirect="{{ route('transaction_goods_movement_cancellation_view') }}" id="form">
        ...
        <input type="hidden" name="doc_number_year" value="{{ substr($header_data['TR_GR_HEADER_PSTG_DATE'],0,4) }}">
                ...
                <div class="col-lg-11">
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <input required type="text" class="form-control date" name="TR_CANCELLATION_MVT_POSTING_DATE" placeholder="Input Posting Date">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" name="doc_number_year" value="{{ substr($header_data['TR_GI_SAPHEADER_PSTG_DATE'],0,4) }}">
        ...
        <input type="hidden" name="doc_number_year" value="{{ substr($header_data['TR_TP_HEADER_PSTG_DATE'],0,4) }}">
        <div class="card-body p-0">
            <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                <div class="col-md-11">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label>Posting Date: <span style="color:red">*</span></label>
                            <input required type="text" class="form-control date" name="TR_CANCELLATION_MVT_POSTING_DATE"
