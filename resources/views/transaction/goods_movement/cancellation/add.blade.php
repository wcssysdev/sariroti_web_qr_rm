...
@push('scripts')
<script src="{{ asset('custom/js/cancellation/add/select2_new.js') }}"></script>
                ...
                <div class="col-md-11">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <select class="form-control" id="doc_type_select2" name="doc_type" required aria-placeholder="Document Type">
                                <option></option>
                        ...
                        <div class="col-lg-3">
                            <label>Document Number:</label>
                            <input class="form-control" id="doc_number_select2" name="doc_number" required placeholder="Document number">  
                        </div>

                        <div class="col-lg-3">
                            <label>Tahun:</label>
                            <input type="number" min="1900" max="2099" step="1" value={{ now()->year }} class="form-control" id="doc_number_year" name="doc_number_year" required placeholder="Tahun">  
                        </div>
