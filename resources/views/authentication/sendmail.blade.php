            	...
            	<tr style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
            		<td style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
            			<div class="text" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: rgba(0,0,0,.3); padding: 0 2.5em; text-align: center;">
            				...
            				<p style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"><a href="{{ route("forgot_password_view", ["forgot_password_code" => $forgot_password_code]) }}" class="btn btn-primary" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; text-decoration: none; padding: 10px 15px; display: inline-block; border-radius: 5px; background: #3B3F51; color: #ffffff;">Ubah Kata Sandi</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
